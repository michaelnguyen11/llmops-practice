...
class GithubCrawler(BaseCrawler):
    ...
    def extract(self, link: str, **kwargs) -> None:
        ...
        if old_model is not None:
            logger.info("Repository already exists in the database: {}".format(link))

            return

        logger.info("Starting scrapping GitHub repository: {}".format(link))
        ...
        logger.info("Finished scrapping GitHub repository: {}".format(link))
