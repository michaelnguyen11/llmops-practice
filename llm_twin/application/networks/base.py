...
class SingletonMeta(type):
    ...
    first access to the Singleton class.    
    """
    ...
    def __call__(cls, *args, **kwargs):
        ...
        # multiple threads can simultaneously pass the previous conditional
        # and reach this point almost at the same time.
        # The first of them will acquire lock and will proceed further, while the rest will wait here.

        with cls._lock:
            # The first thread to acquire the lock, reaches this conditional,
            # go inside and creates the Singleton instance.
            # Once it leaves the lock block,
            # a thread that might have been waiting for the lock release may then enther this section.
