...
def delete_endpoint_and_config(endpoint_name: str) -> None:
    ...
    Args:
        endpoint_name(str): The name of SageMaker endpoint to delete.
    Returns:
        None
    """
    ...
    try:
        ...
        logger.exception("Failed to create SageMaker client")
        return
    ...
    try:
        ...
        logger.error("Failed to get endpoint configuration and modelname.")
        return
